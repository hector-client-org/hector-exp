...
public class ConcurrentHClientPool implements HClientPool {
  ...
  // TODO this needs to simplify: we really have two states: available and in-use
  // https://github.com/apache/tomcat/blob/trunk/modules/jdbc-pool/src/main/java/org/apache/tomcat/jdbc/pool/ConnectionPool.java
  ...
  // borrow semantics: wrap a quickly acquired connection, delegating setup and testing:
  // https://github.com/apache/tomcat/blob/trunk/modules/jdbc-pool/src/main/java/org/apache/tomcat/jdbc/pool/ConnectionPool.java#L602
